...
function inputEmpty(){
    let desc = document.getElementById('inputDescription');
    let hour = document.getElementById('inputHora');

    if(hour.value == ""){
        let input = document.getElementById('inputHora');
        return input.focus();
}
    if(desc.value == ""){
                ...
                <form id="formtask">
                    <div class="topper">
                            ...
                            <div class="description">
                                ...
                                <input type="text" name="descricao" id="inputDescription" placeholder="Arrumar a casa">
